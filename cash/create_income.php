...
<div class="main-content">
 ...
 <a class="btn btn-success" href="index.php">GO BACK</a>
   ...
   <h2 align="center">Add New Incum</h2>
   <form action="store_income.php" method = "post">
...
<tr>
   <div class="form-group">
   <td><label for="description">Incum</label></td> 
    <td><input type="text" class="form-control" id="description" placeholder="description" name="description" required></td> 
  </div>
  </tr>
  <tr>
  <div class="form-group">
    <td><label for="incum">Taka</label></td> 
    <td><input type="text" class="form-control" id="incum" placeholder="Taka" name="incum"></td> 
  </div>
  </tr>
  </table>
