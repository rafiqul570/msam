...
<div class="main-content">
 ...
 <a class="btn btn-success" href="index.php">GO BACK</a>
   ...
   <h2 align="center">বেতন ও ফিস আদায়ের রশিদ</h2><br>
   <form action="store.php" method = "post">
    <table class="table table-bordered">
      ...
      <tr>
      <th>বেতন/ফিস</th>
      <td> <input type="text" class="form-control" id="des" placeholder="" name="des" required></td>
      </tr>
      <tr>
      <th>টাকা</th>
      <td><input type="text" class="form-control" id="taka" placeholder="taka" name="taka" required></td>
      </tr>
      </table>
